...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        devMaria.progredir();
        System.out.println("Voce tem " + devMaria.getConteudosConcluidos() + " conteudos concluidos!");
        System.out.println("Restam " +  devMaria.getConteudosInscritos().size() + " conteudos para conclusão");
